...
model.add(LSTM(6, activation='tanh', return_sequences=False))
...
checkpoint = ModelCheckpoint('rnn_512_6-{epoch:03d}-{acc:03f}-{val_acc:03f}.h5', verbose=0, monitor='val_loss',save_best_only=True, mode='auto') 
