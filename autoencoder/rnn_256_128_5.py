...
model.add(LSTM(128, activation='tanh', input_shape=(reg_num,one_hot_len), return_sequences=True))
...
checkpoint = ModelCheckpoint('rnn_256_128_5-{epoch:03d}-{acc:03f}-{val_acc:03f}.h5', verbose=0, monitor='val_loss',save_best_only=True, mode='auto') 
